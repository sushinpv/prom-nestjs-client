...
import { requestCountGenerator, requestDurationGenerator, requestLengthGenerator, responseLengthGenerator, restErrorResponseHistogram } from "./metrics";
 ...
 */
export const metricsLogError = (controller: string, error: Error & { status?: boolean }) => {
...
export default (userOptions = {}) => {
   ...
   * of the RED metrics.
   */
  const redMiddleware = ResponseTime((req: express.Request, res: express.Response, time) => {
  ...
  routeApp.get(metricsPath, async (req: any, res: any, next: any) => {
