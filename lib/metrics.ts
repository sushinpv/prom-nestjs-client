 ...
 * request counter
 */
function requestCountGenerator(labelNames: string[], prefix = "") {
 ...
 * request duration
 */
function requestDurationGenerator(labelNames: string[], buckets: number[], prefix = "") {
 ...
 * request length
 */
function requestLengthGenerator(labelNames: string[], buckets: number[], prefix = "") {
  return new Prometheus.Histogram({
 ...
 * response length
 */
function responseLengthGenerator(labelNames: string[], buckets: number[], prefix = "") {
  return new Prometheus.Histogram({
